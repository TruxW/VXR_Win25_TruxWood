...
{
    [SerializeField] protected private Transform m_playerTarget;
    [SerializeField] public float m_attackRate = 3f;
    [SerializeField] public float m_attackRange = 10f;
    [SerializeField] public int m_attackDamage = 1;

    [SerializeField] protected private float m_moveSpeed = 0.5f;
